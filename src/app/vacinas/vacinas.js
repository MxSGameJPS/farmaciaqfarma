const vacinas = [
  {
    ...
    "previne": "Infecção causada pelos quatro sorotipos de dengue: DEN1, DEN2, DEN3 e DEN4. A eficácia na prevenção da doença é de 65,5%; na prevenção de dengue grave e hemorrágica é de 93% e de internação é de mais de 80%.",
    "composicao": "Vacina atenuada, composta pelos quatro sorotipos vivos do vírus dengue, obtidos separadamente por tecnologia de DNA recombinante. Contém ainda aminoácidos essenciais (incluindo fenilalanina), aminoácidos não essenciais, cloridrato de arginina, sacarose, trealose di-hidratada, sorbitol, trometamol e ureia. O diluente é constituído por cloreto de sódio e água para injeções. Não contém adjuvantes e conservantes.",
    "indicacao": "Crianças a partir de 9 anos de idade, adolescentes e adultos até 45 anos.",
    "contraindicacao": [
    ...
    "efeitos_adversos": {
      ...
      "observacoes": "As reações foram geralmente de gravidade leve a moderada e de curta duração (até três dias). O início foi tipicamente observado em até três dias após a vacinação, com exceção da febre, que surge dentro de 14 dias após a aplicação da vacina. As reações adversas sistêmicas tendem a ser menos frequentes após a segunda e a terceira doses. A febre foi menos frequente nos indivíduos com mais de 18 anos de idade. Hematoma e coceira no local da injeção foram menos frequente indivíduos dos 9 aos 17 anos de idade."
    }
  },
  {
    "vacina": "Vacina dTpa (Tríplice Bacteriana Acelular do Tipo Adulto)",
    "previne": "Difteria, tétano e coqueluche.",
    "composicao": "Vacina inativada. Contém os toxoides diftérico e tetânico, e componentes da cápsula da bactéria da coqueluche (Bordetella pertussis), sal de alumínio como adjuvante, fenoxietanol, cloreto de sódio e água para injeção. A quantidade de toxoide diftérico e de componentes pertussis é menor que na vacina infantil (DTPa).",
    "indicacao": [
    ...
    "contraindicacao": "Pessoas que apresentaram anafilaxia ou sintomas neurológicos causados por algum componente da vacina ou após a administração de dose anterior.",
    "esquema_doses": [
    ...
    "efeitos_adversos": {
      "em_criancas_ate_9_anos": {
        ...
        "incomuns": "Distúrbios da atenção, irritação nos olhos e erupção na pele (0,1% a 1%)."
      },
      "em_criancas_a_partir_de_10_anos_adolescentes_e_adultos": {
        ...
        "incomuns": "Sintomas respiratórios, faringite, aumento dos gânglios linfáticos, síncope (desmaio), tosse, diarreia, vômito, transpiração aumentada, coceira, erupção na pele, dor articular e muscular e febre acima de 39ºC (0,1% a 1%)."
      },
      "geral": [
  ...
  },
  {
    ...
    "contraindicacao": "Pessoas que apresentaram anafilaxia após uso de componentes da vacina ou dose anterior.",
    "esquema_doses": [
  ...
  },
  {
    ...
    "transmissao": "Em áreas urbanas, principalmente pelo mosquito Aedes aegypti. Nas áreas silvestres, o vírus também é encontrado em macacos, e a transmissão ocorre através de mosquitos que os picam.",
    "composicao": "Vacina atenuada. É composta de vírus vacinal amarílico vivo atenuado (enfraquecido), cultivado em ovo de galinha. Pode conter sacarose, glutamato, sorbitol, gelatina bovina, eritromicina, canamicina, cloridrato de L-histidina, L-alanina, cloreto de sódio e água para injeção.",
    "indicacao": "Crianças a partir de 9 meses de idade, adolescentes e adultos que vivem em regiões brasileiras classificadas como áreas de recomendação de vacinação, ou em viagem nacional/internacional de risco para a doença, ou com obrigatoriedade de comprovação da vacinação.",
    "contraindicacao": [
    ...
    "esquema_doses": {
      "areas_com_recomendacao": "Rotina: duas doses (aos 9 meses e 4 anos). Para quem não recebeu as doses de rotina: duas doses com intervalo de dez anos.",
      "viajantes": "Uma dose. Se dez anos depois a pessoa se deslocar para a área com recomendação, uma segunda dose deve ser aplicada. Em situações de exigência, a primeira dose deve ter sido aplicada no mínimo dez dias antes da viagem."
    },
    "local_aplicacao": "Subcutânea.",
    "cuidados": [
      "Não são necessários cuidados especiais antes da vacinação.",
    ...
    "efeitos_adversos": {
      "locais": "Dor no local de aplicação em 4% dos adultos e um pouco menos em crianças, dura um ou dois dias, na forma leve ou moderada.",
      "gerais": "Febre, dor de cabeça e muscular são os eventos mais frequentes e acontecem em cerca de 4% dos que são vacinados na primeira vez e menos de 2% nas segundas doses.",
      "graves_e_raros": [
  ...
  },
  {
    ...
    "composicao": "Vacina inativada. É composta por polissacarídeos da cápsula da bactéria (Salmonella typhi), fenol, cloreto de sódio, fosfato dissódico diidratado, fosfato monossódico diidratado e água para injeção.",
    "indicacao": [
    ...
    "contraindicacao": "Hipersensibilidade conhecida a qualquer um dos componentes da vacina.",
    "esquema_doses": "Uma dose. A vacina confere proteção por três anos, sendo a revacinação recomendada após este período se o risco de adoecimento persistir ou retornar.",
    ...
    "efeitos_adversos": {
      "mais_frequentes_locais": "Dor (3,6% a 9,4%), vermelhidão (2,4% a 5,4%), inchaço (1,7% a 1,8%).",
      "outras_reacoes_possiveis": "Febre (1,5% a 16,2%), dor de cabeça (10% a 7,8%), mal-estar (0,9% a 4%), náuseas (2,1% a 5%) e coceira (1,7% a 1,8%)."
    }
  },
  {
    "vacina": "Vacina Contra Gripe Quadrivalente",
    "previne": "Infecção pelo vírus Influenza (que causa a gripe) contidos nas vacinas.",
    "composicao": "Vacina inativada. Contém proteínas de diferentes cepas do vírus Influenza (definidas anualmente). As cepas são cultivadas em ovos, e por isso as vacinas contêm traços de proteínas do ovo. Pode conter traços de formaldeído e antibióticos (geralmente gentamicina ou neomicina). Apresentação multidose contém timerosal. Também contém cloreto de sódio e água para injeção.",
    "indicacao": "Para todas as pessoas a partir de 6 meses de vida, principalmente aquelas de maior risco para complicações.",
    "contraindicacao": "Pessoas com alergia grave (anafilaxia) a ovo de galinha, a algum componente da vacina ou a dose anterior.",
    "esquema_doses": {
      "criancas_6_meses_a_9_anos": "Duas doses na primeira vez, com intervalo de um mês e revacinação anual.",
      "criancas_maiores_9_anos_adolescentes_adultos_e_idosos": "Dose única anual."
    },
    "local_aplicacao": "Intramuscular.",
    "cuidados": [
    ...
    "efeitos_adversos": {
      "locais": "Dor, vermelhidão e endurecimento em 15% a 20% dos vacinados. Reações leves e desaparecem em até 48 horas.",
      "sistemicas": "Febre, mal-estar e dor muscular acometem 1% a 2% dos vacinados. Têm início de seis a 12 horas após a vacinação e persistem por um a dois dias, sendo mais comuns na primeira vez em que tomam a vacina. Reações anafiláticas são raríssimas.",
      "sindrome_de_guillain_barre": "Pode ocorrer, mas é uma relação rara e controversa."
    }
  },
  {
    ...
    "composicao": "Vacina inativada. É composta de pó liofilizado com polissacarídeo da cápsula da bactéria Haemophilus influenzae tipo b (Hib) conjugado com toxoide tetânico, lactose, cloreto de sódio, água para injeção. Apresentações multidose contêm fenol e a vacina da rede pública tem timerosal. Pode ser encontrada isolada ou combinada com a vacina tríplice bacteriana (DTPw ou DTPa).",
    "indicacao": [
    ...
    "contraindicacao": "Pessoas que apresentaram anafilaxia provocada por qualquer componente da vacina ou por dose anterior.",
    "esquema_doses": {
      "pni": "Três doses: aos 2, 4 e 6 meses de idade.",
      "sbp_sbim": "Quarta dose entre 12 e 18 meses, em especial para crianças vacinadas com a vacina DTPa.",
    ...
    "efeitos_adversos": {
      "locais": "Dor (3% a 29%), inchaço, endurecimento e vermelhidão (0,2% a 17%).",
      "gerais": "Febre (1% a 6%), cansaço, tontura, dor de cabeça, irritabilidade e desconforto gastrintestinal leve (1% a 20%).",
      "alergias": "Um a cada 600 mil vacinados apresenta alergia a algum componente, sobretudo ao timerosal."
    }
  },
  {
    "vacina": "Vacina Hepatite A",
    "previne": "Hepatite A.",
    "composicao": "Vacina inativada. É composta por antígeno do vírus da hepatite A, sal de alumínio amorfo, estabilizante, cloreto de sódio a 0,9%. Pode conter traços de antibiótico (neomicina), fenoxietanol e formaldeído.",
    "indicacao": "Todas as pessoas a partir de 12 meses de vida.",
    "contraindicacao": "Pessoas que tiveram reação anafilática a algum componente da vacina ou a dose anterior.",
    "esquema_doses": {
  ...
  },
  {
    ...
    "composicao": "Vacina inativada. É composta do vírus inativado (morto) da hepatite A e da proteína de superfície do vírus da hepatite B. Também possui: sais de alumínio, formaldeído, sulfato de neomicina, fenoxietanol, polissorbato 20, cloreto de sódio e água para injeção.",
    "indicacao": "Crianças a partir dos 12 meses, adolescentes e adultos. É uma boa opção para pessoas que não foram vacinadas contra as duas hepatites.",
    "contraindicacao": [
    ...
    "esquema_doses": {
      "criancas_e_adolescentes_1_a_15_anos": "Duas doses com intervalo de seis meses.",
      "adolescentes_a_partir_16_anos_e_adultos": "Três doses, sendo a segunda um mês após a primeira e a terceira cinco meses após a segunda."
    },
  ...
  },
  {
    ...
    "composicao": "Vacina inativada. Contém antígeno formado por componentes das cápsulas das bactérias (oligossacarídeos) dos sorogrupos A, C, W e Y conjugados a uma proteína que pode ser o toxoide tetânico ou o mutante atóxico da toxina diftérica (CRM-197). Pode conter também sacarose; trometamol; fosfato de potássio diidrogenado; cloreto de sódio; fosfato de sódio diidrogenado monoidratado; fosfato dissódico hidrogenado diidratado; e água para injeção.",
    "indicacao": [
    ...
    "contraindicacao": "Pessoas que tiveram anafilaxia após o uso de algum componente da vacina ou após dose anterior.",
    "esquema_doses": {
      "criancas": "Iniciar aos 3 meses com três doses no primeiro ano de vida e reforços aos 12 meses, 5 anos e 11 anos.",
      "adolescentes": "Duas doses com intervalo de cinco anos, se nunca receberam a vacina.",
      "adultos": "Dose única."
    },
    "local_aplicacao": "Intramuscular profunda.",
    "cuidados": [
    ...
    "efeitos_adversos": {
      ...
      "entre_0.01_e_0.1_porcento": "Inchaço extenso no membro em que foi aplicada a vacina, principalmente em adultos."
    }
  },
  {
    ...
    "composicao": "Vacina inativada. É composta por quatro componentes, três proteínas subcapsulares e a membrana externa do meningococo B, hidróxido de alumínio, cloreto de sódio, histidina, sacarose e água para injeção. Podem existir traços de canamicina.",
    "indicacao": [
      "Para crianças e adolescentes, conforme recomendações da SBP e SBIm.",
    ...
    "contraindicacao": "Pessoas que tiveram anafilaxia após uso de algum componente da vacina ou após dose anterior.",
    "esquema_doses": "Informação não fornecida no texto original. O texto apenas menciona que as sociedades médicas recomendam o uso, mas não especifica o esquema de doses.",
    "local_aplicacao": "Intramuscular.",
    "cuidados": [
    ...
    "efeitos_adversos": {
      "em_criancas_menores_2_anos": {
        "mais_de_10_porcento": "Febre alta com duração de 24 a 28 horas. Perda de apetite, sonolência, choro persistente, irritabilidade, diarreia, vômitos, erupções na pele, sensibilidade no local da aplicação e ao movimentar o membro onde foi aplicada a vacina, reações locais (dor, calor, vermelhidão, inchaço).",
        "entre_0.01_e_0.1_porcento": "Urticária e outras reações alérgicas."
      },
      "em_mais_de_11_anos": {
        "mais_de_10_porcento": "Cefaleia, náuseas, dor nos músculos e articulações, mal-estar e reações locais, como inchaço, endurecimento, vermelhidão e dor."
      }
    }
  },
  {
    "vacina": "Vacina Pentavalente",
    "previne": "DTPa-VIP/Hib: difteria, tétano, coqueluche, meningite por Haemophilus influenzae tipo b e poliomielite.",
    "composicao": "Vacinas inativadas. Contém os componentes da vacina tríplice bacteriana acelular (DTPa), componente da bactéria Haemophilus influenzae tipo b conjugado e vírus inativados (mortos) da poliomielite tipos 1, 2 e 3. A composição inclui ainda: lactose, cloreto de sódio, 2-fenoxietanol, hidróxido de alumínio e água para injeção. Pode conter traços de antibiótico (estreptomicina, neomicina e polimixina B), formaldeído e soroalbumina de origem bovina.",
    "indicacao": "Recomendada para crianças a partir de 2 meses de idade e podem ser aplicadas até os 7 anos, sempre que seja indicada cada uma das vacinas incluídas nessas combinações.",
    "contraindicacao": [
      "Maiores de 7 anos.",
    ...
    "esquema_doses": "Para a vacinação rotineira de crianças (aos 2, 4, 6 meses e entre 12 e 18 meses), preferir o uso da vacina quíntupla (penta) ou sêxtupla (hexa). Para reforço entre 4 e 5 anos de idade, recomenda-se o uso de DTPa ou dTpa-VIP.",
    "local_aplicacao": "Intramuscular.",
    "cuidados": [
      "Não são necessários cuidados especiais antes da vacinação.",
      "Em caso de doença aguda com febre alta a vacinação deve ser adiada.",
    ...
    "efeitos_adversos": {
      "locais": "Até 21% das crianças vacinadas experimentam reações no local da aplicação (vermelhidão, dor, inchaço).",
      "gerais": "Até 22% podem ter febre maior que 38ºC; e 1,9% pode ter febre a partir de 40ºC. 1% pode manifestar perda de apetite, vômito, irritabilidade, choro persistente e sonolência.",
      "incomuns_ou_raros": "De 0,01% a 1% pode apresentar convulsão febril e episódio hipotônico-hiporresponsivo (EHH); menos de 0,01%, problemas neurológicos, inchaço transitório nas pernas com roxidão ou pequenos sangramentos transitórios, e anafilaxia. Os eventos adversos são um pouco mais frequentes nas doses de reforço."
    }
  },
  {
    "vacina": "Vacina Pneumocócica 13 - prevenar",
    "previne": "Cerca de 90% das doenças graves (pneumonia, meningite, otite) em crianças, causadas por 13 sorotipos de pneumococos.",
    "composicao": "Vacina inativada. É composta de 13 sorotipos de Streptococcus pneumoniae (pneumococo) conjugados com a proteína CRM197. Contém também sais de alumínio, cloreto de sódio, ácido succínico, polissorbato 80 e água para injeção.",
    "indicacao": [
    ...
    "contraindicacao": "Crianças que apresentaram anafilaxia após usar algum componente da vacina ou após dose anterior.",
    "esquema_doses": {
      "rotina_infantil": "Quatro doses: aos 2, 4 e 6 meses de vida e reforço entre 12 e 15 meses.",
      "criancas_1_a_2_anos_nao_vacinadas": "Duas doses com intervalo de dois meses.",
      "criancas_2_a_5_anos_nao_vacinadas": "Uma dose.",
      "criancas_acima_6_anos_e_adultos": "Dose única. Em algumas situações, duas doses com intervalo de dois meses podem estar indicadas.",
    ...
    "efeitos_adversos": {
      "em_criancas": {
        "mais_de_10_porcento": "Diminuição do apetite, irritabilidade, sonolência ou sono inquieto, febre e reações no local da aplicação (dor, vermelhidão, inchaço ou endurecimento).",
        "entre_1_e_10_porcento": "Diarreia, vômitos, erupção cutânea, febre acima de 39°C.",
        "entre_0.1_e_1_porcento": "Choro persistente, convulsões, urticária, reação local intensa.",
        "entre_0.01_e_0.1_porcento": "Episódio hipotônico-hiporresponsivo (EHH) e anafilaxia."
      },
      "em_adultos": {
        "mais_de_10_porcento": "Diminuição do apetite, dor de cabeça, diarreia, erupção cutânea, dor nas articulações, dor muscular, calafrios, cansaço e reações locais (endurecimento, inchaço, dor, limitação do movimento do braço).",
        "entre_1_e_10_porcento": "Vômitos e febre.",
        "entre_0.1_e_1_porcento": "Náusea, alergia grave, gânglios no braço vacinado."
      }
    }
  },
  {
    ...
    "composicao": "Vacina inativada. É composta de partículas purificadas (polissacarídeos) das cápsulas de 23 tipos de Streptococos pneumoniae (pneumococo), cloreto de sódio, água para injeção e fenol.",
    "indicacao": [
    ...
    "contraindicacao": "Crianças, adolescentes e adultos que apresentaram anafilaxia causada por algum componente ou dose anterior da vacina.",
    "esquema_doses": "Recomenda-se a combinação da VPP23 com a VPC13. Idealmente, iniciar o esquema com vacina conjugada e aplicar uma dose da VPP23 seis a doze meses depois, e outra cinco anos após a primeira dose de VPP23. Na maioria das vezes não se recomenda aplicar mais de duas doses de VPP23.",
    "local_aplicacao": "Intramuscular.",
    "cuidados": [
      "Não são necessários cuidados especiais antes da vacinação.",
      "Em caso de febre, adiar a vacinação até que ocorra a melhora.",
    ...
    "efeitos_adversos": {
      "mais_de_10_porcento": "Dor no local da aplicação (60,0%), inchaço ou endurecimento (20,3%), vermelhidão (16,4%), dor de cabeça (17,6%), cansaço (13,2%) e dor muscular (11,9%).",
      "menos_de_10_porcento": "Reações locais mais intensas, com inchaço de todo braço, hematoma e manchas vermelhas."
    }
  },
  {
    "vacina": "Vacina Rotavírus Pentavalente",
    "previne": "Doença diarreica causada por rotavírus.",
    "composicao": "Vacina oral atenuada pentavalente (VR5) é composta por cinco tipos de rotavírus vivos 'enfraquecidos', sacarose, citrato de sódio, fosfato de sódio monobásico monoidratado, hidróxido de sódio, polissorbato 80, meios de cultura e traços de soro fetal bovino.",
    "indicacao": "Bebês de 6 semanas a 8 meses e 0 dia. A primeira dose deve ser obrigatoriamente aplicada até a idade de 3 meses e 15 dias, e a última dose até os 7 meses e 29 dias.",
    "contraindicacao": [
    ...
    "esquema_doses": "Três doses, com intervalo mínimo de quatro semanas. Esquema padrão: 2, 4 e 6 meses de idade. A idade máxima para começar a vacinação é 3 meses e 15 dias, e para a última dose é 7 meses e 29 dias.",
    ...
    "efeitos_adversos": {
      "gerais": "Sintomas de gastrenterite ocorrem em menos de 10% dos vacinados. O risco de invaginação intestinal é pequeno, muito menor que o risco de hospitalização ou óbito por gastrenterite por rotavírus."
    }
  },
  {
    "vacina": "Vacina Tetra Viral",
    "previne": "Sarampo, caxumba, rubéola e varicela.",
    "composicao": "Vacina atenuada, contendo vírus vivos “enfraquecidos” do sarampo, da rubéola, da caxumba e da varicela (catapora), lactose anidra, sorbitol, manitol, aminoácidos, traços de neomicina e água para injeção. Contém traços de proteína do ovo de galinha.",
    "indicacao": [
    ...
    "esquema_doses": "O sistema público disponibiliza uma dose aos 15 meses de idade. A SBP e SBIm recomendam duas doses: aos 12 meses e entre 15 e 24 meses.",
    "local_aplicacao": "Subcutânea.",
    "cuidados": [
  ...
  },
  {
    ...
    "composicao": "Vacina atenuada, contendo vírus vivos “enfraquecidos” do sarampo, da rubéola e da caxumba; aminoácidos; albumina humana; sulfato de neomicina; sorbitol e gelatina. Contém traços de proteína do ovo de galinha e uma das vacinas da rede pública contém traços de lactoalbumina (proteína do leite de vaca).",
    ...
    "efeitos_adversos": {
      "locais": "Ardência, vermelhidão, dor e formação de nódulo em menos de 0,1% dos vacinados.",
      "gerais": "Febre alta (5% a 15%), dor de cabeça, irritabilidade, febre baixa, lacrimejamento e vermelhidão dos olhos, coriza, manchas vermelhas no corpo (5%) e gânglios inchados.",
      "raros": [
        "Inflamação das meninges (meningite).",
        "Inflamação do cérebro (encefalite).",
        "Manifestações hemorrágicas (púrpura trombocitopênica).",
  ...
  },
  {
    ...
    "composicao": "Vacina atenuada, contendo vírus vivos “enfraquecidos” da varicela, além de gelatina, traços de neomicina e água para injeção. Não contém traços de proteína do ovo de galinha.",
    "indicacao": "Recomendada de rotina para crianças com mais de 12 meses (excepcionalmente, a partir de 9 meses em situações de surto). Todas as crianças, adolescentes e adultos suscetíveis (que não tiveram catapora) devem ser vacinados.",
    "contraindicacao": [
    ...
    "esquema_doses": {
      ...
      "sbp_sbim": "Duas doses: a primeira aos 12 meses e a seguinte entre 15 e 24 meses de idade.",
      "criancas_mais_velhas_adolescentes_e_adultos": "Duas doses com intervalo de um a dois meses.",
      "surto": "Em situação de surto, a vacina pode ser aplicada em bebês a partir de 9 meses (a dose é desconsiderada e a criança deverá tomar as duas doses de rotina)."
    },
    "local_aplicacao": "Subcutânea.",
    "cuidados": [
    ...
    "efeitos_adversos": {
      "gerais": "Taxa de eventos adversos variando de 5% a 35% em indivíduos imunocompetentes.",
      "locais": "Dor (26%) e vermelhidão (5%) no local da aplicação. Vesículas próximas ao local em 1% a 3%.",
      "exantema": "Exantema pelo corpo, semelhante à catapora, em 3% a 5% dos indivíduos, com duas a cinco lesões, aparecendo entre cinco e 26 dias após a vacinação."
    }
  }
];
